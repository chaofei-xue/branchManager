...
一个面向 Git 分支日常操作的交互式脚本，入口文件是 [branch_manager.py](/Users/xue/file/claude/branchManager/branch_manager.py)。
...
```bash
python3 /Users/xue/file/claude/branchManager/branch_manager.py
```
